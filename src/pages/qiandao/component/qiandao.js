  ...
  initQQMap = () => {
    ...
    render(){
        return(
           <div className='k'>
               <div className='s'>
                    <h4>*搜索目标经度显示区*<input id='' style={{display:'inline-block',width:'260px'}} value={this.state.lat}></input> </h4>           
                    <h4>*搜索目标纬度显示区*<input id='' style={{display:'inline-block',width:'260px'}} value={this.state.lng}></input></h4>
               </div>
                 <div className='s1'>
                        搜索目标所在的城市:  <input id='region' style={{display:'inline-block',width:'20%'}} defaultValue={'北京'} placehoulder='城市'></input>
                        <span style={{margin:'0 0 0 25px'}}>搜索目标的具体名称:</span><input id='keyword' className='d' style={{display:'inline-block',width:'30%'}} defaultValue={'乐高'} placeholder='地址'></input>
                         <button className='s2' onClick={this.searchKeyword} >位置搜索</button>
                 </div>
                 <button className='s3' onClick={this.dingwei} style={{width:'10%',height:'30%'}}>位置定位</button>
